	...
	<TABLE BORDER=<?php echo $borda?> WIDTH=100% style='height: 500px' CELLSPACING=0>
		<tr>
			...
			<!--INICIO-DO-CONTEUDO-DA-PAGINA-->
				<form name="form1" action="perguntas_lacunas_03.php" method="post">
						...
						<fieldset class="grupo">
							<div class="campo">
								<label for="dgtPergunta">Digite a(s) lacuna(s) na respectiva ordem do enunciado:&nbsp</label>
								<?php
								...
								<TABLE BORDER=0 CELLSPACING=0>
									<tr><td>
										...
										<textarea rows="1" style="width: 35em" id="dgtAlternativa_<?php echo $alternativasMinimo?>" name="dgtAlternativa_<?php echo $alternativasMinimo?>"></textarea>
									</td></tr>
								</table>
								<?php
									$alternativasMinimoChar++;
