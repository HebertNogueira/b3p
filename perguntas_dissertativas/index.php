<?php
	...
	$dadosDificuldade = mysqli_query($conecta,$queryDificuldade) or die(mysql_error($conecta));
	$resultDificuldade = mysqli_fetch_assoc($dadosDificuldade);
	
	$queryCampus = sprintf("SELECT * FROM qcampus");
	$dadosCampus = mysqli_query($conecta,$queryCampus) or die(mysql_error($conecta));
	...
	<TABLE BORDER=<?php echo $borda?> WIDTH=100% style='height: 500px' CELLSPACING=0>
		<tr>
			...
			<!--INICIO-DO-CONTEUDO-DA-PAGINA-->
				<form name="form1" action="perguntas_dissertativas_02.php" method="post">
