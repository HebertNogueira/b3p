<?php
	...
	//tratamento SESSION dificuldade
	...
	//tratamento SESSION Alternativas
	$qtdAlternativasPost = $_SESSION['tipoPergunta'];
	
	//tratamento SESSION questão
	$qtdDgtPergunta = $_SESSION['dgtPergunta'];
	
	//tratamento SESSION tag's
	$qtdDgtTags = $_SESSION['dgtTags'];
	
	//tratamento SESSION codigo
			...
			<!--INICIO-DO-CONTEUDO-DA-PAGINA-->			
					<form action="../questoes_incluir.php" method="post">
						...
						<div class="campo">
							...
							<?php
								$sqlOutputAlternativas = "SELECT descricaoAlternativa,correta FROM qAlternativas where codQuestao='$codQuestao' ORDER BY opcao ASC";	
