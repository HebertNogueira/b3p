<?php
	...
	$dadosOutputQuestoes = mysqli_query($conecta,$queryOutputQuestoes) or die(mysql_error($conecta));
	...
	<TABLE BORDER=<?php echo $borda?> WIDTH=100% style='height: 500px' CELLSPACING=0>
		<tr>
			...
			<!--INICIO-DO-CONTEUDO-DA-PAGINA-->
				<form name="form1" action="perguntas_dissertativas_03.php" method="post">
							...
							<div class="campo">
								...
								<TABLE BORDER=0 CELLSPACING=0>
									<tr><td>
										...
										<textarea rows="4" style="width: 34.2em" id="dgtAlternativa_<?php echo $alternativasMinimo?>" name="dgtAlternativa_<?php echo $alternativasMinimo?>"></textarea>
									</td></tr>
								</table>
								<?php
									$alternativasMinimoChar++;
